...
DB = mysql.connect(user='root', password='06LOG08kat', host='localhost', database='v2')
...
for k in range(86): 
    mylist[k].to_csv(f'C:/Users/sylke/OneDrive/Documenten/THESIS/DATA/1_CSVS/new_validate_concurrent/mylist_full/{k}_dataset.csv', index=False)
