...
for k in range(datasets): 
    reconstructed[k].to_csv(f'C:/Users/sylke/OneDrive/Documenten/THESIS/DATA/1_CSVS/new_validate_concurrent/AE_DATA_LENGTH/{k}_w_1_reconstructed.csv', index=False)
