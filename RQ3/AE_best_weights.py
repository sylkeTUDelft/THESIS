# -*- coding: utf-8 -*-
"""
Created on Sun Nov 19 20:39:41 2023
...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct  3 12:47:23 2023
...
folder_path_olr = 'C:/Users/sylke/OneDrive/Documenten/THESIS/DATA/1_CSVS/new_validate_concurrent/OLR_full'

# folder_path_mylist = 'C:/Users/sylke/OneDrive/Documenten/THESIS/DATA/1_CSVS/mylist_observations_v3'
# folder_path_concurrent = 'C:/Users/sylke/OneDrive/Documenten/THESIS/DATA/1_CSVS/concurrent_df_observations_v3'
# folder_path_validate = 'C:/Users/sylke/OneDrive/Documenten/THESIS/DATA/1_CSVS/validate_df_observations_v3'
# folder_path_olr = 'C:/Users/sylke/OneDrive/Documenten/THESIS/DATA/1_CSVS/OLR_OBS_results_Q1_v3'
...
print('only computing for uk7 siddick')
validate = [validate[11]].copy()
concurrent = [concurrent[11]].copy()
datasets = 1
...
# set weights
w_wind_speed = 1
# best_wind_direction_weights = [0.2, 0.8, 1, 0.4, 0.7, 0.4, 0.4, 0.4, 0.2, 0.1, 0.7, 0.1, 0.1, 1, 1, 0.5, 0.5, 0.2, 0.3, 0.2, 0.1, 1, 0.4,
#                                0.1, 0.4, 0.3, 0.1, 0.2, 0.5, 0.7, 0.1, 0.1, 0.3, 0.1, 0.1]
best_wind_direction_weights = [0.1]
...
for k in range(datasets): 
    ...
    m_dataset = []
    # select the kth wind direction weight
    w_wind_direction = best_wind_direction_weights[k]
    print(w_wind_direction)
    # get dataset indices
...
# for k in range(datasets): 
#     reconstructed[k].to_csv(f'C:/Users/sylke/OneDrive/Documenten/THESIS/DATA/1_CSVS/new_validate_concurrent/AE_best_weights/{k}_w_{best_wind_direction_weights[k]}_reconstructed.csv', index=False)
    


for k in range(datasets): 
    reconstructed[k].to_csv(f'C:/Users/sylke/OneDrive/Documenten/THESIS/DATA/1_CSVS/new_validate_concurrent/AE_best_weights/11_w_{best_wind_direction_weights[k]}_reconstructed.csv', index=False)
